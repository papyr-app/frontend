...
<div class="fixed right-4 bottom-4 w-80 max-h-[80vh] bg-gray-100 p-4 rounded-lg shadow-lg flex flex-col">
  <div class="messages flex-1 overflow-y-auto mb-4 space-y-2">
    {#each $messages as msg}
      <div class="p-2 rounded-lg bg-white shadow-sm">
        <span class="font-semibold text-blue-500">{msg.username}:</span> {msg.message}
      </div>
    {/each}
  </div>
