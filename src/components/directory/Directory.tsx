...
export default function Directory({ treeNode, handleShowEditModal, handleShowShareModal }: DirectoryProps) {
    ...
    return (
        <li className='directory-container' onClick={(e) => toggleOpen(e)}>
            <div className="directory-name">
                {isOpen ? <SlFolderAlt className='directory-icon' /> : <SlFolder className='directory-icon' />} {treeNode.name}
            </div>
